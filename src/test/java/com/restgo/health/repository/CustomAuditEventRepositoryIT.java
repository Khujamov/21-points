package com.restgo.health.repository;

import com.restgo.health.TwentyOnePointsApp;

import com.restgo.health.config.Constants;
import com.restgo.health.config.audit.AuditEventConverter;
import com.restgo.health.domain.PersistentAuditEvent;
...
import static com.restgo.health.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
